...
<div class="content-wrapper iframe-mode" data-widget="iframe" data-loading-screen="750">
  ...
  <div class="tab-content">
    ...
    <div class="tab-pane fade" id="panel-index-html" role="tabpanel" aria-labelledby="tab-index-html"><iframe src=".//"></iframe></div>
  </div>
</div>
```
...
Example: `$('.content-wrapper').IFrame('createTab', 'Home', '/, 'index', true)`
